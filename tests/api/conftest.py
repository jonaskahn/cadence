...
def mock_tenant_service() -> MagicMock:
    ...
    svc.create_org = AsyncMock(return_value=_default_org)
    ...
    svc.get_org = AsyncMock(return_value=_default_org)
...
def mock_settings_service() -> MagicMock:
    ...
    _default_org_setting = MagicMock()
    _default_org_setting.value = None
    svc.org_settings_repo = MagicMock()
    svc.org_settings_repo.get_by_key = AsyncMock(return_value=None)
    ...
    svc.get_org_quota = AsyncMock(return_value=_default_quota)
    svc.list_tier_definitions = AsyncMock(
        return_value=[
            {
                "key": "tier.free",
                "tier_name": "free",
