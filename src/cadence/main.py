...
class CadenceApplication:
    ...
    def create_app(self) -> FastAPI:
        ...
        async def health_check():
            return {"status": "healthy", "message": "Cadence 🤖 Multi-agents AI Framework", "version": "1.0.12"}

        @self.app.get("/")
        async def root():
            return {"message": "Welcome to Cadence 🤖 Multi-agents AI Framework", "version": "1.0.12", "docs": "/docs"}
