...
async def list_system_plugins(request: Request, tag: Optional[str] = None):
    ...
    try:
        ...
        return [_serialize_system_plugin_response(plugin) for plugin in plugins]
...
async def get_system_plugin(plugin_id: str, request: Request):
    ...
    try:
        ...
        return _serialize_system_plugin_response(plugin)
    except HTTPException:
        raise
    except Exception as e:
...
def _serialize_system_plugin_response(plugin: SystemPlugin) -> SystemPluginResponse:
