...
class GlobalSettings(BaseModel):
    ...
    key = Column(String(STANDARD_STRING_LENGTH), nullable=False, unique=True)
    value = Column(JSONB, nullable=False)
    value_type = Column(String(SHORT_STRING_LENGTH), nullable=False)
    description = Column(Text)
    overridable = Column(Boolean, default=False, nullable=False)
    category = Column(String(SHORT_STRING_LENGTH), nullable=True)
    created_at = Column(DateTime(timezone=True), default=utc_now, nullable=False)
    updated_at = Column(
        DateTime(timezone=True), default=utc_now, onupdate=utc_now, nullable=False
    )
    created_by = Column(String(STANDARD_STRING_LENGTH), nullable=True)
    updated_by = Column(String(STANDARD_STRING_LENGTH), nullable=True)
...
class Organization(BaseModel):
    ...
    status = Column(String(SHORT_STRING_LENGTH), nullable=False, default="active")
    created_at = Column(DateTime(timezone=True), default=utc_now, nullable=False)
    updated_at = Column(
        DateTime(timezone=True), default=utc_now, onupdate=utc_now, nullable=False
    )
    ...
    domain = Column(String(STANDARD_STRING_LENGTH), nullable=True)
    subscription_tier = Column(
        String(SHORT_STRING_LENGTH), nullable=False, default="free"
    )
    description = Column(Text, nullable=True)
    contact_email = Column(String(STANDARD_STRING_LENGTH), nullable=True)
    website = Column(String(LONG_STRING_LENGTH), nullable=True)
    logo_url = Column(String(VERY_LONG_STRING_LENGTH), nullable=True)
...
class OrganizationSettings(BaseModel):
    ...
    key = Column(String(STANDARD_STRING_LENGTH), nullable=False)
    value = Column(JSONB, nullable=False)
    overridable = Column(Boolean, default=False, nullable=False)
    created_at = Column(DateTime(timezone=True), default=utc_now, nullable=False)
    updated_at = Column(
...
class OrganizationLLMConfig(BaseModel):
    ...
    name = Column(String(STANDARD_STRING_LENGTH), nullable=False)
    provider = Column(String(SHORT_STRING_LENGTH), nullable=False)
    api_key = Column(Text, nullable=False)
    base_url = Column(String(LONG_STRING_LENGTH), nullable=True)
...
class OrchestratorInstance(BaseModel):
    ...
    name = Column(String(STANDARD_STRING_LENGTH), nullable=False)
    framework_type = Column(String(SHORT_STRING_LENGTH), nullable=False)
    mode = Column(String(SHORT_STRING_LENGTH), nullable=False)
    status = Column(String(SHORT_STRING_LENGTH), nullable=False, default="active")
...
class User(BaseModel):
    ...
    email = Column(String(STANDARD_STRING_LENGTH), nullable=True)
    password_hash = Column(Text, nullable=True)
    is_sys_admin = Column(Boolean, default=False, nullable=False)
    display_name = Column(String(STANDARD_STRING_LENGTH), nullable=True)
    created_at = Column(DateTime(timezone=True), default=utc_now, nullable=False)
    updated_at = Column(
        DateTime(timezone=True), default=utc_now, onupdate=utc_now, nullable=True
    )
...
class SystemPlugin(BaseModel):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid4)
    pid = Column(String(STANDARD_STRING_LENGTH), nullable=False)
    version = Column(String(SHORT_STRING_LENGTH), nullable=False)
    name = Column(String(STANDARD_STRING_LENGTH), nullable=False)
    description = Column(Text, nullable=True)
    tag = Column(String(100), nullable=True)
    is_latest = Column(Boolean, nullable=False, default=False)
    s3_path = Column(String(LONG_STRING_LENGTH), nullable=True)
    default_settings = Column(JSONB, nullable=True, default=dict)
    capabilities = Column(JSONB, nullable=True, default=list)
    agent_type = Column(
        String(SHORT_STRING_LENGTH), nullable=False, default="specialized"
    )
...
class ProviderModelConfig(BaseModel):
    ...
    Attributes:
        id: Primary key
        provider: Provider identifier (openai, anthropic, google, groq, azure, litellm)
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    provider = Column(String(SHORT_STRING_LENGTH), nullable=False)
    model_id = Column(String(STANDARD_STRING_LENGTH), nullable=False)
    display_name = Column(String(STANDARD_STRING_LENGTH), nullable=False)
