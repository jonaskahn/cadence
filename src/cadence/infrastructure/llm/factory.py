...
Supported frameworks:
  ...
  - Framework.OPENAI_AGENTS → OpenAI Agents SDK model  (openai, litellm)
  - Framework.GOOGLE_ADK    → Google ADK model         (google, litellm)
"""
...
class LLMModelFactory:
    ...
    def _decrypt_api_key(encrypted_key: str) -> str:
        ...
        # TODO: Implement decryption using a key management service.
    ...
    def _instantiate_model(
        ...
        dispatch = {
            Framework.LANGGRAPH: lambda: provider_class.create_model(
            ...
            Framework.OPENAI_AGENTS: lambda: provider_class.create_openai_agents_model(
                model_name=model_name,
                api_key=api_key,
                base_url=base_url,
                **additional_config,
            ),
            Framework.GOOGLE_ADK: lambda: provider_class.create_google_adk_model(
                model_name=model_name,
                api_key=api_key,
                base_url=base_url,
                **additional_config,
