...
based on framework type (LangGraph, OpenAI, Google) and mode
...
class BackendRegistryEntry:
    """Registry entry grouping the three classes for a framework/mode combination."""
...
_BACKEND_CONFIGS: list[tuple[str, str, Type, Type, Type]] = [
    (
        "langgraph",
        "supervisor",
        LangChainAdapter,
...
class OrchestratorFactory:
    ...
    def __init__(
        ...
        self.registry: dict[tuple[str, str], BackendRegistryEntry] = {}
    ...
    def _initialize_registry(self) -> None:
        ...
        for (
            ...
            self.registry[(framework_type, mode)] = BackendRegistryEntry(
                adapter_class=adapter_cls,
                orchestrator_class=orchestrator_cls,
                streaming_wrapper_class=wrapper_cls,
            )
    ...
    def register_backend(
        ...
        """
        registry_key = (framework_type, mode)
        self.registry[registry_key] = BackendRegistryEntry(
