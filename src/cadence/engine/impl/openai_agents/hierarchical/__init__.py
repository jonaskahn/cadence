"""OpenAI Agents SDK hierarchical orchestrator — not yet implemented."""
...
class OpenAIHierarchical(BaseOrchestrator):
    """Placeholder hierarchical orchestrator for OpenAI Agents SDK. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("OpenAI Agents SDK hierarchical is not yet implemented")

    async def astream(self, state: UvState) -> AsyncIterator[StreamEvent]:
        raise NotImplementedError(
            "OpenAI Agents SDK hierarchical is not yet implemented"
        )
