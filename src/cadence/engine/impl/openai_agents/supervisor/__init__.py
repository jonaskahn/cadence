"""OpenAI Agents SDK supervisor orchestrator — not yet implemented."""
...
class OpenAISupervisor(BaseOrchestrator):
    """Placeholder supervisor for OpenAI Agents SDK. Not yet implemented."""
    ...
    def __init__(
        ...
        self.mode_config = SupervisorMode(
