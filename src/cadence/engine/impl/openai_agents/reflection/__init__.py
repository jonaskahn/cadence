"""OpenAI Agents SDK reflection orchestrator — not yet implemented."""
...
class OpenAIReflection(BaseOrchestrator):
    """Placeholder reflection orchestrator for OpenAI Agents SDK. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("OpenAI Agents SDK reflection is not yet implemented")

    async def astream(self, state: UvState) -> AsyncIterator[StreamEvent]:
        raise NotImplementedError("OpenAI Agents SDK reflection is not yet implemented")
