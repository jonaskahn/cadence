"""OpenAI Agents SDK handoff orchestrator — not yet implemented."""
...
class OpenAIHandoff(BaseOrchestrator):
    """Placeholder handoff orchestrator for OpenAI Agents SDK. Not yet implemented."""
