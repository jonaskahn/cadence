"""Google ADK pipeline orchestrator — not yet implemented."""
...
class GoogleADKPipeline(BaseOrchestrator):
    """Placeholder pipeline orchestrator for Google ADK. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("Google ADK pipeline is not yet implemented")

    async def astream(self, state: UvState) -> AsyncIterator[StreamEvent]:
        raise NotImplementedError("Google ADK pipeline is not yet implemented")
