"""Google ADK handoff orchestrator — not yet implemented."""
...
class GoogleADKHandoff(BaseOrchestrator):
    """Placeholder handoff orchestrator for Google ADK. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("Google ADK handoff is not yet implemented")
