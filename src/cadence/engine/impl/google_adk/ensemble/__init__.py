"""Google ADK ensemble orchestrator — not yet implemented."""
...
class GoogleADKEnsemble(BaseOrchestrator):
    """Placeholder ensemble orchestrator for Google ADK. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("Google ADK ensemble is not yet implemented")

    async def astream(self, state: UvState) -> AsyncIterator[StreamEvent]:
        raise NotImplementedError("Google ADK ensemble is not yet implemented")
