"""Google ADK hierarchical orchestrator — not yet implemented."""
...
class GoogleADKHierarchical(BaseOrchestrator):
    """Placeholder hierarchical orchestrator for Google ADK. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("Google ADK hierarchical is not yet implemented")

    async def astream(self, state: UvState) -> AsyncIterator[StreamEvent]:
        raise NotImplementedError("Google ADK hierarchical is not yet implemented")
