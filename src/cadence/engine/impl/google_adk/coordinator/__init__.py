"""Google ADK coordinator orchestrator — not yet implemented."""
...
class GoogleADKCoordinator(BaseOrchestrator):
    """Placeholder coordinator for Google ADK. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("Google ADK coordinator is not yet implemented")
