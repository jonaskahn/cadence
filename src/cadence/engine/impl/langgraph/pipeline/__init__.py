"""LangGraph pipeline orchestrator — not yet implemented."""
...
class LangGraphPipeline(BaseLangGraphOrchestrator):
    """Placeholder pipeline orchestrator for LangGraph. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("LangGraph pipeline is not yet implemented")

    async def astream(self, state: UvState) -> AsyncIterator[StreamEvent]:
        raise NotImplementedError("LangGraph pipeline is not yet implemented")
