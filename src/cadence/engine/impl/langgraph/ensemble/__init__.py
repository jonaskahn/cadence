"""LangGraph ensemble orchestrator — not yet implemented."""
...
class LangGraphEnsemble(BaseLangGraphOrchestrator):
    """Placeholder ensemble orchestrator for LangGraph. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("LangGraph ensemble is not yet implemented")

    async def astream(self, state: UvState) -> AsyncIterator[StreamEvent]:
        raise NotImplementedError("LangGraph ensemble is not yet implemented")
