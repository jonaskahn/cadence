"""LangGraph coordinator orchestrator — not yet implemented."""
...
class LangGraphCoordinator(BaseLangGraphOrchestrator):
    """Placeholder coordinator for LangGraph. Not yet implemented."""
    ...
    async def _build_resources(self) -> None:
        self.logger.warning("LangGraph coordinator is not yet implemented")

    async def astream(self, state: UvState) -> AsyncIterator[StreamEvent]:
        raise NotImplementedError("LangGraph coordinator is not yet implemented")
